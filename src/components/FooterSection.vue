    ...
    <div class="foot-inner">
      <div class="isak effectFade fadeUp no-div">
        <svg viewBox="0 0 354 160" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 157.225V6.93641H19.4068V157.225H0Z" fill="black" fill-opacity="0.72" />
          <path
      ...
      <a href="#" class="f-logo">
        <div class="logo">
          <img :src="isDark ? logoDark : logoLight"
               class="image-switch"
               :data-light="logoLight"
               :data-dark="logoDark"
               loading="lazy" width="32" height="32" alt="Image">
        </div>
      </a>
    </div>
    <div class="foot-bottom">
      <p class="text-nocopy text-black-56">
      ...
      <div class="isak">
        <svg viewBox="0 0 428 162" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            stroke="black" stroke-opacity="0.56" />
        </svg>
      </div>
    </div>
  </div>
